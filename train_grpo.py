...
# Custom imports
from trainer_baseline import dllmGRPOTrainer
...
def main(grpo_config, model_config):
    ...
    print("Initializing dllmGRPOTrainer with deepspeed passed in json...")
    ...
    print("Initializing dllmGRPOTrainer...")
    trainer = dllmGRPOTrainer(
        args=grpo_config,
